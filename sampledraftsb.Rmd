...
keywords          : "keywords"
wordcount         : "X"
bibliography      : "/Users/samihabhushan/Documents/financial/researchcit.bib"
floatsintext      : no
figurelist        : no
tablelist         : no
footnotelist      : no
...
# Theory
**Mechanisms behind agency independance**
...
**"Information capture" in regulations**
...
**org_name:** Name(s) of congresspeople represented in the comment. 

**position:** A number from -2 (strongly opposed) to 2 (strongly supports)
...
# Results
```{r analysis-preferences7, echo=TRUE}
# Number of congresspeople  data
data4 <- read.csv(("/Users/samihabhushan/Documents/financial/congressno.csv"), header=F)
data4
```
