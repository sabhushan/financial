...
d1 <- read_sheet("https://docs.google.com/spreadsheets/d/1HBjG32qWVdf9YxfGPEJhNmSw65Z9XzPhHdDbLnc3mYc/edit?usp=sharing")
load("/Users/samihabhushan/Downloads/members (1).Rdata")
d3 <- read.table(file = "/Users/samihabhushan/financial/data/federal_agencies_clean.xlsx", sep="\t", header = TRUE)
```
